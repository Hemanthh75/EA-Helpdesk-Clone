  ...
  return (
    <div className="manage-account-container">
      <div className="manage-grid-container">
        <div className="manage-grid-item" onClick={() => navigate("/sign-in")}>
        ...
        <div className="manage-grid-item" onClick={() => navigate("/my-cases")}>
          <div className="manage-grid-item-icon">
        ...
        <div
          className="manage-grid-item"
          onClick={() => navigate("/my-ban-history")}
        >
          <div className="manage-grid-item-icon">
