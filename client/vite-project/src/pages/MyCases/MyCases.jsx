               ...
               <div className="my-cases-container">
                    <div className="my-cases-content">
                        <div className="my-cases-content-description">
                            <p className="my-cases-content-description-text">Please sign into your EA Account to proceed.</p>
                            <img className="my-cases-content-description-Image" src="/Images/MyCases/EALogo.png" alt="" />
                ...
                {/* Creating the my cases page input form */}
                        <div className="my-cases-content-inputs">
                            <h2 className="my-cases-content-inputs-heading">Access an Individual Case:</h2>
                            <form>
                                ...
                                <button type="submit" className="my-cases-content-inputs-btn">View Case</button>
                            </form>
                        </div>
                   </div>
